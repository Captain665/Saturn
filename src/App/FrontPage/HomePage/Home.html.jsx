    ...
    return (
        <>
            <div className="md:w-11/12 w-full m-auto">
                ...
                <ul className="flex justify-between md:px-10 px-3 w-full h-full md:mt-5 mt-16">
                ...
                <dialog open={dialog} id="dialog" className={`top-0 flex justify-center items-center w-full h-screen bg-transparent ${dialog ? "bg-opacity-30 bg-gray-200" : "hidden"}`}>
                    <form className="md:w-2/6 w-11/12 border-2 px-10 md:py-5 py-2 flex flex-col gap-5 bg-white rounded-xl shadow-2xl z-50" method="post" onSubmit={handleOnClick}>
                        <ul className="flex border items-center h-12 bg-gray-100 gap-2 mt-5 text-lg">
                            <li className="bg-white md:p-2 h-full px-4 flex justify-center self-center items-center">
                                <FaTrain />
                            </li>
                            <li className="w-full">
                                <input type="number"
