...
export default function ItemInfo({ outletInfo, itemList, removeItem, addItem}) {
    return (
        <>
            <div className="md:w-2/3 bg-rose-200 rounded-xl shadow-md flex flex-col align-center align-top h-fit m-0.5">
                <p className="text-center font-medium md:text-2xl p-4 shadow-lg bg-rose-300 rounded-md text-lg">Cart Summary</p>
