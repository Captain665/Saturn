    ...
    return (
        <><div className="flex flex-col w-full">
            ...
            {stations?.map(station => (
                <div className={`${station.serviceable ? "shadow-lg" : null} w-11/12 md:w-1/2 content-center self-center h-28 px-4 bg-white border m-1 rounded-md md:h-36 cursor-pointer`}>
